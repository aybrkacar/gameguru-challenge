...
namespace Project1.General
{
    public class InputManager : NonPersistentSingleton<InputManager>
    {
        ...
        public Vector3 _firstPos, _lastPos, _diff;
        ...
        public void TouchDown()
        {
            ...
            Ray ray = _orthoCam.ScreenPointToRay(Input.mousePosition);

            RaycastHit hitInfo;
            if (Physics.Raycast(ray, out hitInfo))
            {
                if(hitInfo.transform.TryGetComponent(out NodeController nodeController)){
